...
@section('content')
    ...
    <form action="/admin/role/{{$role['id']}}" method="post" class="layui-form">
        @csrf @method('PUT')
        ...
        @php
        $bs_node_ids=(old('bs_node_ids')!==null || count($errors)>0)?(array)old('bs_node_ids'):array_ids($role->nodes->toArray());
        @endphp
        <div class="layui-form-item container-fluid">
            <div class="form-group row">
        ...
        @php
            $status=old('status')!==null?old('status'):$role['status'];
        @endphp
        <div class="layui-form-item container-fluid">
            <div class="form-group row">
